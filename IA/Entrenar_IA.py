...
entrenamiento_datagen = ImageDataGenerator(
    rescale=1.0
    / 255,  # cada px va de 0 a 255, con esto se pasara al rango de 0 a 1, para procesar mas facil
...
prueba_datagen = ImageDataGenerator(rescale=1.0 / 255)
